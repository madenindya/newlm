...
class ExperimentScript:
    ...
    def run_ensemble(self, base_dir=None, l2r_r2l_ratio=[1,1], merge_strategy=None):
        ...
        for task in tasks:
            ...
            if merge_strategy is not None:
                merge_strategy(base_dir, task, l2r_r2l_ratio)
            else:
    ...
    def run_predict_ensemble_v2(self):
        ori_output_dir = self.output_dir
        # Run L2R
        ...
        # Run ensemble
        self.output_dir = ori_output_dir
        self.run_ensemble(base_dir=ori_output_dir, merge_strategy=self.merge_ensemble_v2)
