...
class ELMOGPTModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        original_shape = flat_input_ids.shape
...
class ELMOBertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        return BaseModelOutputWithPastAndCrossAttentions(
            last_hidden_state=(None, r2l_outs.last_hidden_state),
            past_key_values=(None, r2l_outs.past_key_values),
            hidden_states=(None, r2l_outs.hidden_states),
            attentions=(None, r2l_outs.attentions),
            cross_attentions=(None, r2l_outs.cross_attentions),
        )
